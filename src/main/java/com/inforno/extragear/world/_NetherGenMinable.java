...
public class _NetherGenMinable extends WorldGenerator
{
    ...
    public _NetherGenMinable(IBlockState state, int blockCount)
    {
        this(state, blockCount, BlockMatcher.forBlock(Blocks.NETHERRACK));
    }

    public _NetherGenMinable(IBlockState state, int blockCount, Predicate<IBlockState> p_i45631_3_)
    {
        this.oreBlock = state;
